...
<sub>[DYOR](https://www.reddit.com/r/sciencememes/comments/xr5qrf/fuck_around_and_find_out/) & [LEARN](https://youtu.be/KqbCAcSj79U)</sub> <sub>*It's like rummaging through the garbage dump. U can also find something useful inside*</sub>

<sub>*below is everything I found*</sub>
...
### - xrpl-hooks-v2 🪝 <sup>*`🐞 testing`*</sup> *Layer1-native-bespoke-lite-smart-contracts*  
  ...
  - *hooks-store* <sup>🚧</sup>
  - XRPL-Labs/hookscript <sup>🚧</sup>[🧱](https://github.com/XRPL-Labs/hookscript) <sub>*subset of typescript*</sub>
  - []()
...
### - flare network<sup>✔️</sup> <sup>`FLR native token`</sup> <sub>*EVM Layer1 smart contracts*</sub>
  ...
  - [🗃️](https://github.com/flare-foundation/docs)[🧰](https://github.com/flare-foundation)[🧰](https://gitlab.com/flarenetwork/)[🐦](https://twitter.com/FlareNetworks)
    - ***`dev prerequisites: js/ts hardhat remix metamask ethers.js chainlink-oracle-net evm-web3`***[👇](#2-sol) 
  - explorers
...
### - web3 defi dex
  ...
  - learning resources
    ...
    - more learning resources[👇](#2-link)[👇](#2-p2p)
  - []()
  - tokens NFT
