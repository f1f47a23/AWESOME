...
### - web3 defi dex
  ...
  - learning resources
    ...
    - Freecodecamp Patrick Collins[🧰](https://github.com/PatrickAlphaC)
      - [▶️](https://youtu.be/gyMwXuJrbJQ)[📝](https://github.com/f1f47a23/AWESOME/blob/main/docs/solidity-eth/Freecodecamp-Patrick-Collins-Learn-Blockchain-Solidity-32hrs.txt)[🧰](https://github.com/smartcontractkit/full-blockchain-solidity-course-js)[🧰](https://github.com/smartcontractkit/full-blockchain-solidity-course-py) <sub>***`see also chainlink`***[👇](#2-link)</sub>
