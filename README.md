...
### - main XLS-#.#d
  - XLS-#.#d [🧱](https://github.com/XRPLF/XRPL-Standards) *XRP Ledger Standards / Drafts*
  ...
  - xrpl-bounties *($$$ rewards $$$)*[🌐](http://xrplbounties.org/)[🧰](https://github.com/XRPLBounties)[🌎](https://dev.to/ripplexdev/help-build-the-future-of-the-xrpl-with-bounties-41fo) *funds software developers and teams for the completion of specific ideas and projects*
  - []()
