...
### - web3 defi dex
  ...
  - learning resources
    ...
    - Freecodecamp Patrick Collins
      - [▶️](https://youtu.be/gyMwXuJrbJQ)[🧰](https://github.com/smartcontractkit/full-blockchain-solidity-course-js)[🧰](https://github.com/smartcontractkit/full-blockchain-solidity-course-py) <sub>***`see also chainlink`***[👇](#2-link)</sub>
...
### - chainlink <sup>`⬡ LINK`</sup> <sub>*decentralized-oracle-net*</sub>
  ...
  - main
    ...
    - blog and forum[📖](https://blog.chain.link/)[📖](https://blog.chain.link/44-ways-to-enhance-your-smart-contract-with-chainlink/)[👨](https://github.com/smartcontractkit/chainlink/issues)ù
